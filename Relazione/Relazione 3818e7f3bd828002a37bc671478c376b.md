...
Le tipologie di connettori disponibili variano a seconda degli standard adottati nelle diverse aree geografiche. In Europa, la direttiva AFIR (che ha sostituito la precedente AFID) ha standardizzato l'utilizzo del connettore Type 2 (Mennekes) per la ricarica in corrente alternata (AC) e del CCS Combo 2 (Combined Charging System) per la ricarica rapida in corrente continua (DC).

Tesla ha inizialmente sviluppato un proprio sistema proprietario di connettori, compatibile sia con la ricarica sia con quella DC. Tuttavia, per i veicoli destinati al mercato europeo, l'azienda ha adottato il connettore CCS Combo 2, uniformandosi agli standard comunitari

I connettori possono inoltre essere classificati in base alla modalità di alimentazione supportata. Nella ricarica in corrente alternata (AC) il convertitore di potenza è generalmente integrato nel veicolo, mentre nella ricarica in corrente continua (DC) la conversione avviene all'interno dell'infrastruttura di ricarica, consentendo l'erogazione di potenze significativamente superiori e tempi di ricarica più ridotti. Per questo motivo i connettori CCS Combo 2 e CHAdeMO sono tipicamente associati alla ricarica rapida e ad alta potenza in corrente continua.
